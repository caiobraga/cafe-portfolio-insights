      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
          {values.map((value, index) => (
            <Card key={index} className="text-center hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border-orange-200 bg-white">
              <CardContent className="p-8">
                <div className="flex justify-center mb-6">
                  <div className="w-16 h-16 bg-gradient-to-br from-[#DF6E2B] to-orange-600 rounded-full flex items-center justify-center shadow-lg">
        ...
        <div className="bg-gradient-to-r from-[#DF6E2B] to-orange-600 rounded-3xl p-12 text-center text-white shadow-2xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <div className="bg-white/20 px-6 py-3 rounded-full backdrop-blur-sm">
              <span className="font-semibold">+15 Projetos Entregues</span>
            </div>
            <div className="bg-white/20 px-6 py-3 rounded-full backdrop-blur-sm">
